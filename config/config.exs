...
config :sable, :scopes,
  user: [
    default: true,
    module: Sable.Accounts.Scope,
    assign_key: :current_scope,
    access_path: [:user, :id],
    schema_key: :user_id,
    schema_type: :binary_id,
    schema_table: :users,
    test_data_fixture: Sable.AccountsFixtures,
    test_setup_helper: :register_and_log_in_user
  ]

config :sable,
  ecto_repos: [Sable.Repo],
...
config :sable, SableWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: SableWeb.ErrorHTML, json: SableWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Sable.PubSub,
  live_view: [signing_salt: "ZtTI8TiK"]
...
config :sable, Sable.Mailer, adapter: Swoosh.Adapters.Local
